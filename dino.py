...
from modeling import GPT2Wrapper, DinoGenerator, PLACEHOLDER_STR, KoGPTWrapper
...
if __name__ == '__main__':
    ...
    if args.model_name == "skt/kogpt2-base-v2":
        model = KoGPTWrapper(model_name=args.model_name, use_cuda=not args.no_cuda) if not args.openai_api_key else args.model_name
    else:

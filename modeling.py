...
from generation import SelfDebiasingGPT2LMHeadModel, SelfDebiasingKoGPTLMHeadModel
...
class KoGPTWrapper(ModelWrapper):

    def __init__(self, model_name: str = "skt/kogpt2-base-v2", use_cuda: bool = True):
        """
        :param model_name: the name of the pretrained GPT2 model (default: "gpt2-xl")
        :param use_cuda: whether to use CUDA
        """
        ...
        self._model = SelfDebiasingKoGPTLMHeadModel.from_pretrained(model_name)  # type: SelfDebiasingKoGPTLMHeadModel
